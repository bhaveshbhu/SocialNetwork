...
//$sql = mysql_query("SELECT id, username, lastname FROM myMembers WHERE email_activated='1' ORDER BY username ASC LIMIT 5"); 
//////////////////////////////////// Adam's Pagination Logic ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$nr = mysql_num_rows($sql); // Get total of Num rows from the database query
$sql2 = mysql_query("SELECT id, username,lastname FROM myMembers WHERE email_activated='1' && acc_type='Faculty' ORDER BY username ASC  LIMIT 5"); 
