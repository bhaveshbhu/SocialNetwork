...
body {
	...
	<form action="upload_pic.php?id=<?php echo $_REQUEST['id'] ?>" method="post" enctype="multipart/form-data"><a style="display:inline-block; line-height:40px; font-size:14px; font-weight:bold; color:black; font-family: tahoma, verdana, arial; background-color: #4ECD1E; height: 40px; width:100%; box-shadow:0px 2px 0px 0px lightgrey;"> <span style="margin-left: 30px;"> Upload Pictures </span> </a>
